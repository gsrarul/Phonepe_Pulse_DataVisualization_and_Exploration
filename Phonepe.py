...
icon = Image.open("C:\\Users\\arulkumar\\Desktop\\MLGuvi\\Phonepe\\Data\\ICN.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Arul",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Arul*!
...
# MENU 1 - HOME
if selected == "Home":
    st.image("C:\\Users\\arulkumar\\Desktop\\MLGuvi\\Phonepe\\Data\\img.png")
    ...
    with col1:
        st.write(" ")
        st.write(" ")
        st.markdown("### :violet[Domain :] Arul")
        st.markdown("### :violet[Technologies used :] Github Cloning, Python, Pandas, MySQL, mysql-connector-python, Streamlit, and Plotly.")
        st.markdown("### :violet[Overview :] In this streamlit web app you can visualize the phonepe pulse data and gain lot of insights on transactions, number of users, top 10 state, district, pincode and which brand has most number of users and so on. Bar charts, Pie charts and Geo map visualization are used to get some insights.")
    with col2:
        st.image("C:\\Users\\arulkumar\\Desktop\\MLGuvi\\Phonepe\\Data\\home.png")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv("C:/Users/arulkumar/Desktop/MLGuvi/Phonepe/Data/Statenames.csv")
            df1.State = df2
